...
function ZkNam(t1,t2)
if t2.id_ then 
name_B = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_B then 
names_B = database:smembers(bot_id.."blocname"..msg.chat_id_) or ""
if names_B and names_B[1] then 
for i=1,#names_B do 
if name_B:match("(.*)("..names_B[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, ZkNam)
end
end
return {
B = blocname,
